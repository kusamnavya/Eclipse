...
<body>
	...
	<h1 style="text-align: center;">QUIZ APPLICATION</h1>

	<div class="jumbotron"
		style="background-color: powderblue; border-collapse: collapse;">

		<form:form action="showRest" method="post">
			<table id="table">
				<core:forEach var="questionPaper" items="${QuestionList}" begin='0'
					end='2'>
					<br />
					<br />
